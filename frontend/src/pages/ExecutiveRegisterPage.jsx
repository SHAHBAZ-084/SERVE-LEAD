...
export default function ExecutiveRegisterPage() {
  ...
  const validateStep = () => {
    const { name, father_name, whatsapp, email, password, otp, program, passing_year, address, city, sls_official_id, cnic_number } = formData;
    if (step === 1) {
      if (!name || !father_name || !whatsapp || !email || !password || !sls_official_id || !cnic_number) return "All fields including SLS ID and CNIC are mandatory.";
      ...
      <section className="bg-[#FAFBFD] py-16 md:py-32 min-h-screen flex items-center justify-center px-4 relative overflow-hidden font-sans">
        ...
        <div className="bg-white p-8 md:p-16 rounded-[2rem] md:rounded-[4rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.08)] w-full max-w-xl border border-slate-100 relative z-10">
          <div className="text-center mb-10 md:mb-14">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-slate-900 mb-4">Executive <span className="gradient-text">Registration</span></h2>
            <div className="flex items-center justify-center gap-2">
              <div className="h-[2px] w-8 bg-[#002147]" />
              <p className="text-slate-400 text-xs font-bold uppercase tracking-[0.3em]">Management Portal</p>
              <div className="h-[2px] w-8 bg-[#002147]" />
            </div>
          </div>
          ...
          {success ? (
            <div className="py-20 text-center animate-fade-up">
              ...
              <p className="text-slate-400 text-sm font-bold uppercase tracking-widest leading-loose max-w-xs mx-auto mb-6">
                Your executive application has been successfully submitted. You will receive dashboard access once verified by the board.
              </p>
              {waLink && (
                <a href={waLink} target="_blank" rel="noopener noreferrer" className="btn-whatsapp">
                  <i className="fab fa-whatsapp text-lg" /> Join Executive Group
                </a>
              )}
              <div className="mt-14 space-y-4">
                ...
                <p className="text-xs font-bold uppercase tracking-[0.4em] text-slate-300">Finalizing profile...</p>
              </div>
            </div>
          ) : (
            <>
                ...
                {step === 1 && (
                  <div className="space-y-7 animate-fade-up">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-7">
                      ...
                      <div className="group">
                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 ml-2 group-focus-within:text-[#002147] transition-colors">02. SLS Official ID</label>
                      ...
                      <div className="group">
                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 ml-2 group-focus-within:text-[#002147] transition-colors">03. CNIC Number</label>
                      ...
                      <div className="group">
                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 ml-2 group-focus-within:text-[#002147] transition-colors">04. Father Name</label>
                      ...
                      <div className="group">
                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 ml-2 group-focus-within:text-[#002147] transition-colors">05. WhatsApp</label>
                      ...
                      <div className="md:col-span-2 group">
                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 ml-2 group-focus-within:text-[#002147] transition-colors">06. Gmail Address</label>
                      ...
                      {otpSent && (
                        <div className="md:col-span-2 group animate-fade-up">
                           <label className="block text-xs font-bold text-emerald-500 uppercase tracking-widest mb-3 ml-2 group-focus-within:text-emerald-600 transition-colors flex items-center gap-2">
                             <i className="fas fa-paper-plane" /> 06B. Enter 6-Digit Code
                           </label>
                      ...
                      <div className="md:col-span-2 group">
                        <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 ml-2 group-focus-within:text-[#002147] transition-colors">07. Portal Password</label>
